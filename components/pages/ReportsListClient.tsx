      ...
      <div className="container mx-auto container-padding">
        <div className="max-w-7xl mx-auto">
          ...
          {reports.length > 0 ? (
            ...
            >
              <div className="w-20 h-20 bg-gradient-to-br from-[#0B334A] to-[#0F4A6A] rounded-xl flex items-center justify-center mx-auto mb-6">
                <span className="text-4xl">📊</span>
              </div>
              <h3 className="text-2xl font-bold text-slate-900 mb-3">No Reports Available</h3>
              <p className="text-slate-600 text-lg max-w-2xl mx-auto">
                We are currently preparing our reports. Please check back soon for updates on our activities, impact, and financial performance.
              </p>
            </motion.div>
          )}
